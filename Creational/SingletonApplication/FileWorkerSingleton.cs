...
namespace SingletonApplication
{
    ...
    /// До этого изменения храняться в динамической памяти.
    /// Реализация паттерна "Одиночка".
    /// </summary>
    public sealed class FileWorkerSingleton
    {
        /// <summary>
        /// Закрытое статистическое поле класса, в котором хранится единственный экземпляр
        ...
        /// создан только один экземпляр класса.
        /// </summary>
        ...
        /// </summary>
        public static FileWorkerSingleton Instanse { get { return instance.Value; } }
