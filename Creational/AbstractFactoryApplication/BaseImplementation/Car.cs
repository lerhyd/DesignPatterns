...
namespace AbstractFactoryApplication.BaseImplementation
{
    ...
    public class Car
    {
        ...
        /// <summary>
        /// Событие перемещения автомобиля за один час.
        ...
        public double Start(double speed)
        {
            ...
            {
                throw new Exception("Вес автомобиля больше максимального. Движение невозможно.");
            }
        ...
        /// Шаг задаётся скоростью. Если скорость в км/ч, то шаг - 1 час.
        /// </summary>
